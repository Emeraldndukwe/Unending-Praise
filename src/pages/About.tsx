    ...
    <div className="bg-[#FAF9F6] text-gray-900 min-h-screen flex flex-col pt-24 overflow-x-hidden w-full">
      ...
      <section className="relative py-16 px-6 md:px-12">
        ...
        <div className="max-w-5xl mx-auto mt-8 sm:mt-12 md:mt-16 flex flex-col gap-0">
          <p className="text-justify leading-6 sm:leading-7 md:leading-8 text-sm sm:text-base md:text-lg text-gray-700 px-4 sm:px-0 mb-0">
          ...
          <p className="text-justify leading-6 sm:leading-7 md:leading-8 text-sm sm:text-base md:text-lg text-gray-700 px-4 sm:px-0 italic mb-0">
