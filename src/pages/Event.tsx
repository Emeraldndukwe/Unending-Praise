...
export default function Event() {
  ...
  const currentEvent = selectedEvent || streamEvents[0];
      ...
      {streamEvents.length > 0 && (
        <section className="relative w-full px-4 md:px-10 pt-10 pb-10 bg-white">
          ...
          <div className="max-w-7xl mx-auto mb-6">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800">TV</h2>
          </div>

          <div className="max-w-7xl mx-auto">
            {!showEventVideo ? (
              // Initial State: Full Video Player
                ...
                <div className="relative w-full aspect-video rounded-3xl shadow-lg overflow-hidden bg-black">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button
                      ...
                      className="bg-[#54037C]/70 hover:bg-purple-800 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg transition-all hover:scale-105"
                    >
                      ▶ Play
                    </button>
                  </div>
              ...
              // Expanded State: Homepage-style layout with video player and Live Comment
